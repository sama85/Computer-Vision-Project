...
#     worldmap_size = Rover.worldmap.shape[0]
#     scale = dst_size * 2
#     x_nav_world, y_nav_world = pix_to_world(xpix = x_nav, ypix = y_nav, xpos = x_rov_pos, 
#     ypos = y_rov_pos, yaw = yaw, world_size = worldmap_size, scale = scale)
#     x_obs_world, y_obs_world = pix_to_world(xpix = x_obs, ypix = y_obs, xpos =  x_rov_pos, 
#     ypos = y_rov_pos, yaw = yaw, world_size = worldmap_size, scale = scale)
#     x_rock_world, y_rock_world = pix_to_world(xpix = x_rock, ypix = y_rock, 
...
#         Rover.worldmap[x_rock_world, y_rock_world, 1] = 255
#         Rover.worldmap[x_obs_world, y_obs_world, 0] += 1
